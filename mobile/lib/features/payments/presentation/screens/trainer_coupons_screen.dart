...
class TrainerCouponsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TrainerCouponsScreen> createState() => _TrainerCouponsScreenState();
}

class _TrainerCouponsScreenState extends ConsumerState<TrainerCouponsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(trainerCouponsProvider.notifier).loadCoupons();
    });
  }
  ...
  Future<void> _reactivateCoupon(TrainerCoupon coupon) async {
    final success = await ref
        .read(trainerCouponsProvider.notifier)
...
class _CouponCard extends StatelessWidget {
  ...
  String _formatUsage(TrainerCoupon coupon) {
    if (coupon.maxUses == 0) {
