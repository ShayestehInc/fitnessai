...
class CommentReplySerializer(serializers.ModelSerializer[Comment]):
    """Serializer for comment replies (no nesting beyond one level)."""
    ...
    class Meta:
        ...
        fields = [
            ...
            'author_first_name', 'author_last_name', 'author_profile_image',
            'content', 'created_at',
        ]
        read_only_fields = ['id', 'post_id', 'parent_comment_id', 'created_at']
...
class CommentSerializer(serializers.ModelSerializer[Comment]):
    """Read serializer for comments with author data and threaded replies."""
    author_id = serializers.IntegerField(source='author.id', read_only=True)
    author_first_name = serializers.CharField(
        source='author.first_name', read_only=True,
    )
